...
function tr(string $key, array $replace = []): string
{
    static $strings = [
        'pt' => [
            ...
            'error.admin_entry_not_configured' => 'O acesso administrativo não está configurado.',
            'error.admin_entry_required' => 'O código de acesso administrativo é obrigatório.',
            'error.admin_entry_invalid' => 'Código de acesso administrativo inválido.',
            'error.invalid_admin_credentials' => 'Credenciais de administrador inválidas.',
            ...
            'error.email_verify_invalid' => 'Código de verificação inválido.',
            'error.email_verify_expired' => 'O código de verificação expirou. Cria a conta novamente ou pede um novo código.',
            'email.verify_subject' => 'Verifica o teu email Greenerry',
            'email.verify_body' => "Olá :name,\n\nUsa este código para ativar a tua conta Greenerry:\n\n:code\n\nEste código expira em 24 horas.\n\nGreenerry",
            ...
            'success.reset_request' => 'Se existir uma conta ativa com esse email, vais receber um código para mudar a palavra-passe.',
            'error.reset_request_save' => 'Não foi possível enviar o código de recuperação.',
            'success.password_reset' => 'Palavra-passe alterada com sucesso. Já podes entrar.',
            'error.reset_invalid' => 'Código de recuperação inválido.',
            'error.reset_expired' => 'O código de recuperação expirou. Pede um novo código.',
            'email.welcome_subject' => 'Bem-vindo ao Greenerry',
            'email.welcome_body' => "Olá :name,\n\nA tua conta Greenerry foi criada com sucesso.\n\nJá podes entrar, ouvir música, seguir artistas e publicar os teus projetos.\n\nGreenerry",
            'email.reset_request_subject' => 'Mudar palavra-passe Greenerry',
            'email.reset_request_body' => "Olá :name,\n\nUsa este código para mudar a tua palavra-passe:\n\n:code\n\nEste código expira em 1 hora.\n\nGreenerry",
            ...
            'email.test_body' => "Este é um email de teste enviado por :site.\n\nSe recebeste isto, o SMTP está a funcionar.",
            ...
            'success.settings_updated' => 'Definições atualizadas com sucesso.',
            ...
            'error.audio_required' => 'Tens de enviar o ficheiro de áudio.',
            'error.audio_format' => 'Formato de áudio não suportado.',
            'error.track_incomplete' => 'Cada faixa tem de ter titulo e ficheiro de áudio.',
            'error.track_format' => 'Foi encontrado um formato de áudio não suportado.',
            ...
            'error.size_exists' => 'Já existe um tamanho com esse código.',
            ...
            'success.product_updated' => 'Produto atualizado com sucesso.',
            ...
            'error.admin_self_deactivate' => 'Não podes desativar a tua própria conta admin.',
            ...
            'receipt.title' => 'Fatura da encomenda #:id',
            ...
            'receipt.footer' => 'Fatura gerada automaticamente pela plataforma Greenerry.',
            'orders.view_receipt' => 'Ver fatura'
        ],
        'en' => [
            ...
            'error.admin_entry_not_configured' => 'Administrative access is not configured.',
            'error.admin_entry_required' => 'The administrative entry key is required.',
            'error.admin_entry_invalid' => 'Invalid administrative entry key.',
            ...
            'error.email_verify_invalid' => 'Invalid verification code.',
            'error.email_verify_expired' => 'The verification code has expired. Create the account again or request a new code.',
            'email.verify_subject' => 'Verify your Greenerry email',
            'email.verify_body' => "Hello :name,\n\nUse this code to activate your Greenerry account:\n\n:code\n\nThis code expires in 24 hours.\n\nGreenerry",
            ...
            'success.reset_request' => 'If an active account exists with that email, you will receive a password reset code.',
            'error.reset_request_save' => 'Could not send the recovery code.',
            'success.password_reset' => 'Password changed successfully. You can now sign in.',
            'error.reset_invalid' => 'Invalid recovery code.',
            'error.reset_expired' => 'The recovery code expired. Request a new one.',
            ...
            'receipt.title' => 'Order invoice #:id',
            ...
            'receipt.footer' => 'Invoice generated automatically by the Greenerry platform.',
            'orders.view_receipt' => 'View invoice'
        ],
    ];
