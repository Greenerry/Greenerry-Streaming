...
(() => {
  const adminTranslations = {
    pt: {
      ...
      dash_average_order_note: 'Média por encomenda paga',
      dash_revenue_trend: 'Evolução da receita',
      ...
      stat_average_order: 'Ticket médio',
      ...
      genres_kicker: 'Taxonomia musical',
      genres_title: 'Generos',
      genres_intro: 'Lista, cria e edita os generos usados nas faixas e lancamentos.',
      genres_new_kicker: 'Musica',
      genres_new_title: 'Novo genero',
      genres_create: 'Criar genero',
      genres_all: 'Generos existentes',
      genres_empty: 'Ainda nao existem generos.',
      sizes_code: 'Código',
      sizes_label: 'Etiqueta',
      sizes_order: 'Ordem',
      sizes_create: 'Criar',
      orders_items: 'Itens',
      orders_kicker: 'Operações',
      orders_title: 'Encomendas',
      orders_intro: 'Acompanha compras, clientes, artistas, moradas, mensagens e estados de entrega.',
      orders_all: 'Todas as encomendas',
      orders_empty: 'Ainda não existem encomendas.',
      orders_order_label: 'Encomenda',
      orders_delivery: 'Entrega',
      orders_summary: 'Resumo',
      orders_artists: 'artistas',
      orders_subtotal: 'subtotal',
      orders_invoice: 'Abrir fatura',
      orders_messages: 'Mensagens da encomenda',
      orders_action: 'Acao',
      users_kicker: 'Contas',
      ...
      reports_money_chart: 'Gráfico do dinheiro',
      reports_blocked_value: 'Cancelado/reembolsado',
      reports_blocked_short: 'Bloqueado',
      reports_income_breakdown: 'Receita detalhada',
      reports_live_finance: 'Financas em direto',
    ...
    en: {
      ...
      products_kicker: 'Catalog review',
      products_title: 'Products',
      products_intro: 'Approve, block, and monitor every Greenerry merch item.',
      products_pending: 'Pending products',
      products_empty_pending: 'No pending products right now.',
      products_empty_all: 'No registered products yet.',
      products_all: 'All products',
      products_image: 'Image',
      products_no_image: 'No image',
      products_reason_placeholder: 'Rejection reason.',
      releases_kicker: 'Music review',
      releases_title: 'Releases',
      releases_intro: 'Approve releases, listen to tracks, and manage music states.',
      releases_pending: 'Pending releases',
      releases_empty_pending: 'No pending releases.',
      releases_empty_all: 'No registered releases yet.',
      ...
      genres_kicker: 'Music taxonomy',
      genres_title: 'Genres',
      genres_intro: 'List, create, and edit the genres used by tracks and releases.',
      genres_new_kicker: 'Music',
      genres_new_title: 'New genre',
      genres_create: 'Create genre',
      genres_all: 'Existing genres',
      genres_empty: 'There are no genres yet.',
      sizes_code: 'Code',
      sizes_label: 'Label',
      sizes_order: 'Order',
      sizes_create: 'Create',
      orders_items: 'Items',
      orders_kicker: 'Operations',
      orders_title: 'Orders',
      orders_intro: 'Track purchases, customers, artists, addresses, messages, and delivery states.',
      orders_all: 'All orders',
      orders_empty: 'There are no orders yet.',
      orders_order_label: 'Order',
      orders_delivery: 'Delivery',
      orders_summary: 'Summary',
      orders_artists: 'artists',
      orders_subtotal: 'subtotal',
      orders_invoice: 'Open invoice',
      orders_messages: 'Order messages',
      ...
      reports_blocked_short: 'Blocked',
      reports_income_breakdown: 'Income breakdown',
      reports_live_finance: 'Live finance',
      reports_paid_short: 'paid',
