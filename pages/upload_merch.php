<?php
// Page purpose: Lets artists create or update merchandising products.
      ...
      <div class="card-body">
        <form method="post" enctype="multipart/form-data" class="stack-form">
          ...
          <div class="frow">
            ...
            <button type="submit" class="btn btn-dark"><?= $editProduct ? '<span data-t="upload_merch_save_review">Guardar e enviar para revisão</span>' : '<span data-t="upload_merch_submit">Enviar produto</span>' ?></button>
            <?php if ($editProduct): ?>
