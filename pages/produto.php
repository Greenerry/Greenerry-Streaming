        ...
        <div class="card-body">
          ...
          <?php if (!empty($product['descricaoProduto'])): ?>
            <div class="product-description" id="product-description">
              ...
              <button type="button" class="product-description-toggle" id="product-description-toggle" data-t="product_read_more" aria-controls="product-description-text" aria-expanded="false">Ver mais</button>
            </div>
          <?php endif; ?>
